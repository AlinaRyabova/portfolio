...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-gradient-to-b from-brand-50 to-white">
      <div className="absolute top-0 right-0 -z-10 w-[500px] h-[500px] bg-brand-100 rounded-full blur-[120px] opacity-70" />
      <div className="absolute bottom-0 left-0 -z-10 w-[400px] h-[400px] bg-accent-400/20 rounded-full blur-[120px] opacity-70" />
      ...
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col gap-6 animate-in slide-in-from-left duration-700">
          ...
          <h1 className="text-5xl md:text-7xl font-bold leading-tight text-brand-900">
          ...
          <div className="flex flex-wrap gap-4 mt-4">
            <a
              href="#contact"
              className="flex items-center gap-2 bg-brand-600 text-white px-8 py-4 rounded-full font-medium hover:bg-brand-700 transition-all shadow-lg shadow-brand-600/20 hover:shadow-brand-600/40"
            >
              {hero.cta}
              <ArrowRight size={20} />
            </a>
            ...
            <a
              ...
              download
              className="flex items-center gap-2 px-8 py-4 rounded-full border border-gray-200 hover:border-brand-600 hover:text-brand-600 text-slate-700 transition-all bg-white shadow-sm"
            >
              <Download size={20} />
              {hero.downloadCv}
            </a>
        ...
        <div className="relative hidden md:block animate-in slide-in-from-right duration-700 delay-200 max-w-[400px] mx-auto w-full">
